...
spec_file=/rhome/cjinfeng/BigData/00.RD/Assembly/Pacbio/Testing_Data/Arabidopsis/pacbio.32c_256g.spec
...
$PBcR_bin/PBcR -threads 32 -length 500 -partitions 200 -l $lib_name -s $spec_file -fastq $fq_file genomeSize=$gsize
