...
cmp=000138F.sort.cmp.h5
ref=citrus_ass_line50_clean.fa
prefix=citrus_ass_test
...
$quiver -j$cpu $cmp -p P6-C4 -r $ref -o $prefix.gff -o $prefix.consensus.fasta -o $prefix.consensus.fastq
