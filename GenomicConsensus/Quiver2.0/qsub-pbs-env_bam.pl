...
$Maxjob ||= 20;
$Convert ||= 'yes';
$Resource ||= "nodes=1:ppn=1,mem=2G,walltime=100:00:00";
$Job_prefix ||= "work";
...
while(<IN>){
	...
	if ($line_mark % $Lines == 0) {
		open OUT,">$Work_dir/$Job_prefix\_$Job_mark.sh" || die "failed creat $Job_prefix\_$Job_mark.sh";
                #print OUT "#!/bin/bash\nPATH=/rhome/cjinfeng/BigData/00.RD/Assembly/Pacbio/install/blasr_20160808/blasr/utils:/rhome/cjinfeng/BigData/00.RD/Assembly/Pacbio/install/blasr_20160808/blasr/:\$PATH\n\n";
                #~/BigData/00.RD/Assembly/Pacbio/install/wgs-8.3rc2/Linux-amd64/bin/blasr
                #print OUT "#!/bin/bash\nPATH=/rhome/cjinfeng/BigData/00.RD/Assembly/Pacbio/install/blasr_20160808/blasr/utils:~/BigData/00.RD/Assembly/Pacbio/install/wgs-8.3rc2/Linux-amd64/bin/:\$PATH\n\n";
                #print OUT "module load bowtie2\n\n";
                print OUT "#!/bin/bash\n\nPYTHONPATH=/rhome/cjinfeng/BigData/00.RD/Assembly/Pacbio/install/pythonlib/:/rhome/cjinfeng/BigData/00.RD/Assembly/Pacbio/install/pythonlib/lib64/python2.7/site-packages/:/rhome/cjinfeng/BigData/00.RD/Assembly/Pacbio/install/pythonlib/lib/python2.7/site-packages/\n\n";
                #print OUT "LD_LIBRARY_PATH=/rhome/cjinfeng/software/tools/SVcaller/Meerkat/src/mybamtools/lib:/rhome/cjinfeng/BigData/software/install/randfold-2.0.1-a7feeeaeba2afe567dbd061b9f4965646386bc98/squid-1.9g/lib:/rhome/cjinfeng/BigData/00.RD/Assembly/Pacbio/install/blasr_20160808/blasr/libcpp/hdf:/rhome/cjinfeng/BigData/00.RD/Assembly/Pacbio/install/blasr_20160808/blasr/libcpp/alignment:/rhome/cjinfeng/BigData/00.RD/Assembly/Pacbio/install/blasr_20160808/blasr/libcpp/pbdata:/rhome/cjinfeng/BigData/00.RD/Assembly/Pacbio/install/hdf5/hdf5-1.8.17-linux-centos6-x86_64-gcc447-shared/lib:\${LD_LIBRARY_PATH}:\${ROOTSYS}/lib\n\n";
                print OUT "LD_LIBRARY_PATH=/bigdata/stajichlab/cjinfeng/00.RD/Assembly/Pacbio/install/pitchfork/deployment/lib:\$LD_LIBRARY_PATH\n\n";
                print OUT "PATH=/bigdata/stajichlab/cjinfeng/00.RD/Assembly/Pacbio/install/pitchfork/deployment/bin:\$PATH\n\n";
